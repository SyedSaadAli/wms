    ...
    <div class="container mt-4">
        ...
        @if(session('success'))
            <div class="alert alert-success">
                {{ session('success') }}<br>
                <strong>An invoice email has also been sent to your registered email address.</strong>
            </div>
        @endif
            ...
            @foreach($orders as $order)
                <div class="card mb-4 shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <strong>Order #{{ $order->id }}</strong> &mdash; Placed on {{ $order->created_at->format('Y-m-d H:i') }}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($item->service && $item->service->image)
                                                    <img src="{{ asset('service_images/' . $item->service->image) }}" alt="Service Image" width="80" height="80" style="object-fit:cover;">
                                                @else
                                                    <img src="https://via.placeholder.com/80x80?text=No+Image" alt="No Image" width="80" height="80" style="object-fit:cover;">
                                                @endif
                                            </td>
