          ...
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <!-- Add Service -->
                <form method="post" action="{{ url('panel/vendor/service/edit/'.$getRecord->id) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            @if ($getRecord->image)
                            <img src="{{ asset('service_images/' . $getRecord->image) }}" alt="Profile" class="rounded-circle" style="width: 150px; height: 150px; object-fit: cover;">
                        @endif
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-12">
                                <textarea name="location" id="location" class="form-control" required>{{ $getRecord->location }}</textarea>
                            </div>
                        </div>
