    ...
    <section class="section">
        ...
        <div class="row">
            ...
            <div class="col-md-6" style="text-align: right;">
                            <a href="{{ url('panel/vendor/venue/add') }}" class="btn btn-primary" style="margin-top: 10px;">Add
                                User</a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @foreach ($venues as $value)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('panel/vendor/venue/edit/' . $value->id) }}"
                                                class="btn btn-primary btn-sm">Edit</a>
                                            <a href="{{ url('panel/vendor/venue/delete/' . $value->id) }}"
